            ...
            <!-- Contact Section -->
               <div class="row justify-content-center">
                  <div class="col-lg-7 mt-2 mt-lg-0 d-flex align-items-stretch">
                     <form method="post" action="assets/php/service-form.php" class="php-email-form">
                        <div class="row">
                        ...
                        <div class="form-group text-center"><button type="submit" name="submit">Send Message</button></div>
                     </form>
                  </div>
               </div>
